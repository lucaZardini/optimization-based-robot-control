...
if __name__ == "__main__":
    ...
    arg_parser.add_argument("--nx", type=int, required=False, default=DefaultValues.NX, help="Number of states")
    arg_parser.add_argument("--nu", type=int, required=False, default=DefaultValues.NU, help="Number of controls")
